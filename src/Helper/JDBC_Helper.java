...
public class JDBC_Helper {
    ...
    static String url = "jdbc:sqlserver://localhost;databaseName=QL_SHOP_GIAY_DU_AN_1";
    static String user = "sa";
    static String pass = "19052003";
    ...
    public static ResultSet query(String sql, Object... args) throws SQLException { // Trả về 1 hoặc tập các câu truy vấn 
        PreparedStatement pstm = JDBC_Helper.getPstm(sql, args); // sử dụng lại phương thức phía trên
    ...
    public static int update(String sql, Object... args) {
        try {
            PreparedStatement pstm = JDBC_Helper.getPstm(sql, args);
            try {
